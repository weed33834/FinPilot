...
def init_default_admin():
    ...
    Admin credentials can be configured via environment variables:
        FINPILOT_ADMIN_EMAIL (default: admin@finpilot.ai)
        FINPILOT_ADMIN_PASSWORD (default: randomly generated)
    ...
    try:
        ...
        if stats["total_users"] == 0:
            ...
            admin_password = os.getenv("FINPILOT_ADMIN_PASSWORD", secrets.token_urlsafe(12))
            crud.create_user(
                db=db,
                email=admin_email,
            ...
            if not os.getenv("FINPILOT_ADMIN_PASSWORD"):
